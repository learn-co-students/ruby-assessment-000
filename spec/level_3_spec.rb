describe "Level 3" do
  describe "Nested Structures" do
    ...
    it "deletes values from nested array" do
	  ...
	  school[:students].delete_if { |e| e[:name] == 'Billy' }
    ...
    it "modifies all values from nested array" do
	  ...
	  school[:students].each { |e| e[:semester] = "Summer" }
    ...
    it "changes value of hash in nested array" do
	  ...
	  school[:instructors].find{|e| e[:name] == "Steven"}[:subject] = "Being Fantastic"
